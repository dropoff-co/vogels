...
describe('Serializer', function () {
  ...
  describe('#serializeItem', function () {
    ...
    it('should serialize encrypted attribute', function(next) {
      ...
      const config = {
        hashKey: 'encrypted',
        schema: {
          encrypted: Schema.types.encrypted(KeyId),
        }
      };
  ...
  describe('#deserializeItem', function () {
    it('should return string value', function (next) {
      const itemResp = {name: 'Tim Tester'};

      serializer.deserializeItem(itemResp, function(error, item) {
    ...
    it('should return values in StringSet', function (next) {
    ...
    it('should return values in NumberSet', function (next) {
    ...
    it('should return null when item is null', function (next) {
      serializer.deserializeItem(null, function(error, item) {
        expect(item).to.be.null;
    ...
    it('should return nested values', function (next) {
      const itemResp = {
        name: 'foo bar',
